...
/** @type {string} */
const CACHE_VERSION = '1733486928|67533652';
/** @type {string} */
const CACHE_PREFIX = 'Вася Нефтяник-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'vasyatheoilworker.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["vasyatheoilworker.html","vasyatheoilworker.js","vasyatheoilworker.offline.html","vasyatheoilworker.icon.png","vasyatheoilworker.apple-touch-icon.png","vasyatheoilworker.worker.js","vasyatheoilworker.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["vasyatheoilworker.wasm","vasyatheoilworker.pck"];
